...
import (
	...
	"github.com/lasthyphen/dijets-network-runner/utils/constants"
	"github.com/lasthyphen/dijets-network-runner/ux"
	...
	avago_constants "github.com/lasthyphen/dijetsnode/utils/constants"
...
func init() {
	...
	flag.StringVar(
		...
		"dijetsnode-path-1",
		"",
		"dijetsnode executable path (to upgrade from)",
	)
	flag.StringVar(
		&execPath2,
		"dijetsnode-path-2",
		"",
		"dijetsnode executable path (to upgrade to)",
	)
	flag.StringVar(
		&subnetEvmPath,
		"subnet-evm-path",
