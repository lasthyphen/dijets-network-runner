...
// Shows example usage of the Dijets Network Runner.
// Creates a local five node Dijets network
...
func main() {
	...
	binaryPath := fmt.Sprintf("%s%s", goPath, "/src/github.com/lasthyphen/dijetsnode/build/dijetsnode")
