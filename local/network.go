...
import (
	...
	"github.com/lasthyphen/dijetsnode/utils/beacon"
...
var (
	...
	snapshotsRelPath = filepath.Join(".dijets-network-runner", "snapshots")
...
// [nodeProcessCreator] is used to launch new dijetsnode processes.
func newNetwork(
	log logging.Logger,
	newAPIClientF api.NewAPIClientF,
	nodeProcessCreator NodeProcessCreator,
