...
import (
	...
	apimocks "github.com/lasthyphen/dijets-network-runner/api/mocks"
	"github.com/lasthyphen/dijets-network-runner/local/mocks"
	healthmocks "github.com/lasthyphen/dijets-network-runner/local/mocks/health"
	"github.com/lasthyphen/dijets-network-runner/network"
	"github.com/lasthyphen/dijets-network-runner/network/node"
	"github.com/lasthyphen/dijets-network-runner/network/node/status"
...
const (
	...
	nodeVersion           = "dijets/1.9.5 extra"
)
...
// check expected number of nodes, node names, and dijetsnode node ids
...
func emptyNetworkConfig() (network.Config, error) {
	...
	// Use a dummy genesis
	genesis, err := network.NewDijetsNodeGenesis(
		networkID,
...
func TestWriteFiles(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "dijets-network-runner-tests-*")
	if err != nil {
		t.Fatal(err)
	}
